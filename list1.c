/*
1. given a string which has values of integers comma seperated, create a linked list. 
example "123,34,456,7893,321" output list as: 123->34->456->7893->321
*/
#include<stdio.h>
#include<stdlib.h>
...
struct test
{
	char input[200];
	char output[200];
}testDB[9]={{"123,456,456","123,456,456"},{"123,34,456,7893,321","123,34,456,7893,321"},
{"\0","\0"},
{"1","1"},
{"\"","\0"},
{"5+2/7,1","\0"},
